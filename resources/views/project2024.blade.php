      ...
      <div id="carouselExampleIndicators" class="carousel slide mt-8" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="{{ asset('images/p.webp') }}" class="d-block w-90 h-80" alt="First slide">
          </div>
          <div class="carousel-item">
            <img src="{{ asset('images/c.webp') }}" class="d-block w-80" alt="Second slide">
          </div>
          <div class="carousel-item">
            <img src="{{ asset('images/d.webp') }}" class="d-block w-80" alt="Third slide">
          </div>
        </div>
